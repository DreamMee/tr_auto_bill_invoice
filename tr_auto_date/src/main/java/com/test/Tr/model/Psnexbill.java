...
public class Psnexbill {
	...
	public void setI_group_id(Integer i_group_id) {
	...
	public Psnexbill(Integer i_group_id, Integer i_mid_id, Date dt_install, Date dt_bill_tr, Date dt_nextbill_tr,
			int contact_id, String title, String product_id, int round, boolean active, String c_plate_number,
			String c_car_code, String c_group_name, String c_comment) {
		super();
		this.i_group_id = i_group_id;
		this.i_mid_id = i_mid_id;
		this.dt_install = dt_install;
	...
	public String toString() {
		return "{i_group_id=" + i_group_id + ", i_mid_id=" + i_mid_id + ", dt_install=" + dt_install
